...
function App() {
  ...
  const onDragEnd = (result) => {
    ...
    let add,
      active = lists,
      listId = source.droppableId - 1

    add = active[listId].tasks[source.index]
    active[listId].tasks.splice(source.index, 1)

    active[listId].tasks.splice(destination.index, 0, add)
    console.log(lists)
    setLists(active)
  }
